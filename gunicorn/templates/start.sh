...
NAME="hydrostats_api"                                      # Name of the application
...
DJANGO_WSGI_MODULE=hydrostats_api.wsgi                     # WSGI module name
...
APPLICATION_LOG=${SOURCE_DIR}/logs/hydrostats_api.log      # Application Log
...
#else
#    echo "Gunicorn is not running. Please check the logs"
#    cat ${SOURCE_DIR}/logs/gunicorn.log
#fi
